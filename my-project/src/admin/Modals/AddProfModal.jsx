  ...
  return isVisible ? (
    <PortalContainer>
      <form
        ...
        className=" bg-gray-300 p-4 rounded-xl shadow-2xl ">
        ...
        <button
          className="my-2 py-1 px-8 rounded text-white  hover:text-gray-600 "
          type="submit"
          id="submit_btn">
        ...
        <button
          className="my-2 py-1 px-8 rounded bg-red-500 text-white hover:bg-red-600 hover:text-gray-600"
          type="button"
          onClick={onClose}>
