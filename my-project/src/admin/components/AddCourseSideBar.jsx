    ...
    return (
        <div className='w-64 flex flex-col items-center rounded-lg bg-slate-200 p-4'>
            ...
            <div className="mb-4">
                ...
                <div className='border border-solid border-black shadow-sm shadow-black bg-white mt-1 px-4 py-2'>{courseTag}</div>
            </div>
            ...
            <button className="mb-4 px-6 py-2 rounded font-bold text-white bg-blue-500 hover:bg-blue-700" type='button'>
                Manual
            </button>

            <label className="mb-4 px-6 py-2 rounded text-white font-bold bg-green-500 hover:bg-green-700 cursor-pointer" htmlFor="file-upload">
                Import
